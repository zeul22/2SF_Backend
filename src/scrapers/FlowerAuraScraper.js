...
exports.FlowerAuraScraper = void 0;
const crypto_1 = require("crypto");
const BaseScraper_1 = require("./BaseScraper");
const utils_1 = require("../shared/utils");
class FlowerAuraScraper extends BaseScraper_1.BaseScraper {
    source = 'FLOWERAURA';
    ...
    async scrapeListPage(page) {
        ...
        const rawItems = await page.$$eval('a[href*="/p/flower/"]', (links) => {
            const items = [];
        ...
        console.log(`[FLOWERAURA] FINAL OFFERS COUNT on ${page.url()}:`, offers.length);
        return offers;
    }
}
exports.FlowerAuraScraper = FlowerAuraScraper;
//# sourceMappingURL=FlowerAuraScraper.js.map